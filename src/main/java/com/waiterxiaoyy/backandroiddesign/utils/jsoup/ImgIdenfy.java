...
public class ImgIdenfy {
    ...
    public static void main(String[] args) {
        String url_safecode = "http://jwxt.gdufe.edu.cn/jsxsd/verifycode.servlet"; // 验证码
        ImgIdenfy imgIdenfy = new ImgIdenfy();
        try {
//            File safeCode = new File("F:/java3.0/JavaSoup/target/classes/safecode.png");
//            InputStream inputStream = new FileInputStream(safeCode);
            ...
            //InputStream is = new URL("http://jwxt.gdufe.edu.cn/jsxsd/verifycode.servlet").openStream();
